...
<head>
    ...
    <title><?= $title ?? 'Provider Dashboard | HomeSwift' ?></title>
...
<body>
        ...
        <div class="header-right">
            ...
            <div class="dropdown">
                <div class="user-menu" data-bs-toggle="dropdown">
                    <div class="user-avatar">
                        <?php if (!empty($provider['profile_picture'])): ?>
                            <img src="<?= APP_URL ?>/<?= $provider['profile_picture'] ?>" alt="Provider" width="35" height="35" class="rounded-circle">
                        <?php else: ?>
                            <i class="fas fa-user"></i>
                        <?php endif; ?>
                    </div>
                    <div class="user-info">
                        <p class="user-name"><?= htmlspecialchars($_SESSION['user_name'] ?? 'Service Provider') ?></p>
                        <p class="user-role">Provider</p>
                    </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="<?= APP_URL ?>/provider/profile">
                            <i class="fas fa-user"></i>
                            Profile
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="<?= APP_URL ?>/provider/settings">
    ...
    <?php include SRC_PATH . '/views/layouts/provider-sidebar.php'; ?>
